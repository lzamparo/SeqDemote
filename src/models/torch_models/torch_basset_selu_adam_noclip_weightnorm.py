...
class BassetRepro(nn.Module):
    ...
    def __init__(self, input_size=(4,1,600)):
        ...
        self.conv1 = nn.utils.weight_norm(Conv2dUntiedBias(4, 300, (1,19), input_size[-1]))
        ...
        self.conv2 = nn.utils.weight_norm(Conv2dUntiedBias(300, 200, (1,11), input_width))
        self.pool2 = nn.MaxPool2d(kernel_size=(1,4), stride=(1,4))
        
        output_width = self.conv2.calc_output_width(input_width,kernel_size=(1,11))
        input_width = output_width // 4
        
        self.conv3 = nn.utils.weight_norm(Conv2dUntiedBias(200, 200, (1,7), input_width))
        ...
        self.fc1 = nn.utils.weight_norm(nn.Linear(conv_size, 1000))
        self.drop1 = nn.Dropout(p=0.3)
        
        self.fc2 = nn.utils.weight_norm(nn.Linear(1000,1000))
        self.drop2 = nn.Dropout(p=0.3)
        
        self.fc3 = nn.utils.weight_norm(nn.Linear(1000,164))
