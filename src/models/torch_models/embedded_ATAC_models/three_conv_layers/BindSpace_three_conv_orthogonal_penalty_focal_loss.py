...
model_hyperparams_dict={'gamma': {'type': 'float', 'min': 0.5, 'max': 3.0},
                        ...
                        'orth_lambda': {'type': 'float', 'min': 0.001, 'max': 0.25},
...
class BindSpaceNet(nn.Module):
    ...
    def __init__(self, input_size=(1, 281, 300), num_factors=24, hyperparams_dict=default_hyperparams):
        ...
        self.orth_conv1 = nn.utils.weight_norm(nn.Conv2d(1, first_filters, (1,300)))
        ...
        self.orth_conv2 = nn.utils.weight_norm(nn.Conv2d(first_filters,second_filters,(30,1)))
        self.orth_conv3 = nn.utils.weight_norm(nn.Conv2d(second_filters,third_filters,(20,1)))
    ...
    def forward(self, input):
        ...
        x = self.relu(self.orth_conv2(x))
        x = self.relu(self.orth_conv3(x))
    ...
    def _forward_features(self, x):
        ...
        x_c2 = self.orth_conv2(x_p1)
        x_c3 = self.orth_conv3(x_c2)
        return x_c3
